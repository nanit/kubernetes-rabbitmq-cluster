...
POD_MEMORY_REQUEST?=$(shell curl -s config/$(NANIT_ENV)/$(CONFIG_NAME)/memory)
POD_CPU_REQUEST?=$(shell curl -s config/$(NANIT_ENV)/$(CONFIG_NAME)/cpu)
